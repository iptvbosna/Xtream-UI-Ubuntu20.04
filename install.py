...
def update(rType="MAIN"):
    if rType == "UPDATE":
        ...
        rlink = input('Example: https://github.com/iptvbosna/Xtream-UI/raw/master/release_22f.zip\n\nNow enter the link:\n\n')
    else:
        rlink = "https://github.com/iptvbosna/Xtream-UI/raw/master/release_22f.zip"
...
def configure():
    ...
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb"): os.system("wget -q https://github.com/iptvbosna/Xtream-UI/raw/master/release_22f.zip/raw/master/GeoLite2.mmdb -O /home/xtreamcodes/iptv_xtream_codes/GeoLite2.mmdb")
    if not os.path.exists("/home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php"): os.system("wget -q https://github.com/iptvbosna/Xtream-UI/raw/master/release_22f.zip/raw/master/pid_monitor.php -O /home/xtreamcodes/iptv_xtream_codes/crons/pid_monitor.php")
